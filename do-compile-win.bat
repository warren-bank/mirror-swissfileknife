...
cl %2 -DSFK_WINPOPUP_SUPPORT sfk.cpp sfknet.cpp patch.cpp inst.cpp kernel32.lib user32.lib gdi32.lib ws2_32.lib advapi32.lib shell32.lib
set MTK_TRACE=
GOTO xdone

:xtrace
echo "compiling trace version"
cl %2 -DWITH_TRACING -DVERBOSE_MEM -DSFK_WINPOPUP_SUPPORT sfk.cpp sfknet.cpp patch.cpp inst.cpp kernel32.lib user32.lib gdi32.lib ws2_32.lib advapi32.lib shell32.lib
