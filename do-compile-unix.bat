...
# g++-3.3 -s sfk.cpp sfkext.cpp -DSFK_LIB5 -o sfk-linux-lib5.exe

# to compile for Mac, use
# g++ -DMAC_OS_X sfk.cpp sfkext.cpp -o sfkmac

# generic ARM compile
# g++ -DLINUX_ARM -DSFK_STATIC -static -s sfk.cpp sfkext.cpp -o sfkarm
