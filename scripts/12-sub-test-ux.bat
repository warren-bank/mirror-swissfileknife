../sfk detab=3 testfiles/Formats/01-native-tab-crlf.txt >/dev/null
...
../sfk remcrlf testfiles/Formats/02-crlf.txt >/dev/null
../sfk test $TCMD T01.3.remcrlf testfiles/Formats/02-crlf.txt

../sfk addcrlf testfiles/Formats/04-lf.txt >/dev/null
...
../sfk snapto=all-src.cpp -dir testfiles :testfiles/Formats -file .hpp .cpp >/dev/null
../sfk test $TCMD T03.1.snapto all-src.cpp

../sfk snapto=all-src-2.cpp -pure -dir testfiles :testfiles/Formats :testfiles/BaseLib -file .hpp .txt -norec >/dev/null
